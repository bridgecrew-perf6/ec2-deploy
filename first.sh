...
password=ichikawa
ssh_port=22
hosted_zone_id=Z08207963QLS1T1DCASQM
domain=devservice.ml
volume_id=0b0087720e5088eee
...
apt install -y nginx
curl https://raw.githubusercontent.com/gattyan27/ec2-deploy/master/http.conf.tmpl -O
