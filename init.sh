...
# install awscli
# cp -p /etc/yum/sources.list /etc/yum/sources.list.bak
# sed -i 's/ap-northeast-1\.ec2\.//g' /etc/yum/sources.list
yum update -y
...
curl https://raw.githubusercontent.com/gattyan27/ec2-deploy/master/config -O
mv config /home/ec2-user/.aws
curl https://raw.githubusercontent.com/gattyan27/ec2-deploy/master/credentials -O
mv credentials /home/ec2-user/.aws
...
cp -r /home/ec2-user/.aws /home/$username
chown -R $username /home/$username/.aws
chgrp -R $username /home/$username/.aws

# register route53
curl https://raw.githubusercontent.com/gattyan27/ec2-deploy/master/dyndns.tmpl -O
...
# ssh config
curl https://raw.githubusercontent.com/gattyan27/ec2-deploy/master/sshd_config.tmpl -O
